...
_images = os.path.join(Addon('plugin.video.Royale').getAddonInfo('path'),'pyxbmct', 'textures', 'default')
#_images = os.getcwd()+'/addons/plugin.video.Royale/pyxbmct/textures/default'
