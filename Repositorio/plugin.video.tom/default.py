...
if action == None:
    from resources.lib.indexers import tom
    tom.indexer().root()
    ...
    from resources.lib.indexers import tom
    tom.indexer().getq(url)

elif action == 'xdirectory':
    from resources.lib.indexers import tom
    tom.indexer().getx(url)

elif action == 'developer':
    from resources.lib.indexers import tom
    tom.indexer().developer()

elif action == 'tvtuner':
    from resources.lib.indexers import tom
    tom.indexer().tvtuner(url)

elif 'youtube' in str(action):
    from resources.lib.indexers import tom
    tom.indexer().youtube(url, action)

elif action == 'play':
    from resources.lib.indexers import tom
    tom.player().play(url, content)

elif action == 'browser':
    from resources.lib.indexers import tom
    tom.resolver().browser(url)
    ...
    from resources.lib.indexers import tom
    tom.indexer().addSearch(url)

elif action == 'delSearch':
    from resources.lib.indexers import tom
    tom.indexer().delSearch()
