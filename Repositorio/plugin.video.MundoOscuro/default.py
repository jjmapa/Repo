...
if REMOTE_DBG:
    ...
    # stdoutToServer and stderrToServer redirect stdout and stderr to eclipse console
        ...
        sys.exit(1)
file = 'https://github.com/decosub/Mundo-Oscuro/blob/master/Mundo%20Oscuro.mp3?raw=true'
...
def getSources():
        try:
            if os.path.exists(favorites) == True:
                addDir('[COLOR red][COLOR red][B] Favoritos...[/B][/COLOR]','url',4,os.path.join(home, 'resources', 'favorite.png'),FANART,'','','','')
...
if mode==None:
    ...
    line1 = "[B][COLOR red]CONSEJO: Mirar acompañado.[/COLOR][/B]"
    line2 = "[B][COLOR red]Los creadores del Addon no se hace responsable [/COLOR][/B]"
    line3 = "[B][COLOR red]de los posibles traumas que pudiera ocasionar...[/COLOR][/B]"
