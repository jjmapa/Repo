...
Base = 'http://manorojakodi.blogspot.com.es/p/add-on-manoroja.html' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.ManoRoja') #    modificar("el nombre de tu addons")
