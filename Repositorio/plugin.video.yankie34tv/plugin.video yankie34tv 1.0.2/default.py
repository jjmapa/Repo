...
php = "aHR0cDovL3lhbmNhcmxpdG9pbmZvcm1hY2lvbi5ibG9nc3BvdC5jb20uZXMvcC9hZGRvbnMteWFua2llMzM0dHYuaHRtbA==".decode("base64")
...
def makeRequest(url, headers=None):
        try:
            ...
            if hasattr(e, 'code'):
                ...
                xbmc.executebuiltin("XBMC.iptv.argento,We failed to reach a server. - "+str(e.reason)+",10000,"+icon+")")
