...
base='http://www.stva.ml'
ADDON=xbmcaddon.Addon(id='plugin.program.stva')
...
EXCLUDES     = ['plugin.program.stva']
HOME         =  xbmc.translatePath('special://home/')

    
def CATEGORIES():
    link = OPEN_URL('https://archive.org/download/Build_201801_201801/wizard.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("STVA Wizard","Descargando ",'', 'Por favor, espere')
...
def FRESHSTART(params):
    ...
    choice2 = xbmcgui.Dialog().yesno("Borrar todo el contenido?", '[COLOR=red]Estas seguro de borrar todo el contenido?[/COLOR]', 'Se borrara todo [B]menos[/B] el addon [COLOR=blue][B]STVA[/B][/COLOR] y tu [COLOR=lime][B]Videoteca[/B][/COLOR]', yeslabel='Si',nolabel='No')
    if choice2 == 0:
        return
    elif choice2 == 1:
