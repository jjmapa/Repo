...
Base = 'http://koditrailers.blogspot.com.es/p/addon-koditrailers.html' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.KodiTrailers') #    modificar("el nombre de tu addons")
