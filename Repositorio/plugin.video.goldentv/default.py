...
if action == None:
    ...
    from resources.lib.indexers import goldentv
    goldentv.indexer().getq(url)

elif action == 'xdirectory':
    from resources.lib.indexers import goldentv
    goldentv.indexer().getx(url)

elif action == 'developer':
    from resources.lib.indexers import goldentv
    goldentv.indexer().developer()

elif action == 'tvtuner':
    from resources.lib.indexers import goldentv
    goldentv.indexer().tvtuner(url)

elif 'youtube' in str(action):
    from resources.lib.indexers import goldentv
    goldentv.indexer().youtube(url, action)

elif action == 'play':
    from resources.lib.indexers import goldentv
    goldentv.player().play(url, content)

elif action == 'browser':
    from resources.lib.indexers import goldentv
    goldentv.resolver().browser(url)

elif action == 'search':
    from resources.lib.indexers import goldentv
    goldentv.indexer().search()

elif action == 'addSearch':
    from resources.lib.indexers import goldentv
    goldentv.indexer().addSearch(url)

elif action == 'delSearch':
    from resources.lib.indexers import goldentv
    goldentv.indexer().delSearch()
