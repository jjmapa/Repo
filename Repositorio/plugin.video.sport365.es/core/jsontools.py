...
def xmlTojson(path_xml):
    ...
    try:
        ...
        import traceback
        logger.info("sport365.es.core.jsontools xmlTojson ERROR al leer el fichero y/o crear el json de " + path_xml)
        logger.info("sport365.es.core.jsontools " + traceback.format_exc())
