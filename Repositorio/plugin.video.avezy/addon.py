...
def listado_categorias(params):
  ...
  titulo01 = "                    [COLOR orange]ArenaVision EZY[/COLOR] Version "+addon_version+" (Wazzu)"
  titulo02 = "                    [COLOR gold]Ultima actualizacion: "+last_update+"[/COLOR]"
  ...
  plugintools.add_item(
    ...
    title      = "[COLOR white][VER AGENDA COMPLETA][/COLOR]",
    plot       = '' ,
  ...
  plugintools.add_item(
    ...
    title      = "[COLOR lime][TODOS LOS CANALES][/COLOR]",
    plot       = '' ,
...
def mostrar_agenda(params):
  ...
  titulo01 = "                [COLOR orange]AGENDA COMPLETA[/COLOR] (actualizado: "+last_update+")"
  plugintools.add_item( title = titulo01 , thumbnail = generar_miniatura('calendar'), action='', url='', isPlayable = False, folder = False )

  # Para cada evento
  for evento in eventos:
    title     = "[COLOR orange]" + evento['fecha'] + " [B]" + evento['hora'] + "[/B][/COLOR] " + evento['titulo']
    plot      = ""
...
def mostrar_canales(params):
  ...
  # Titulo de la categoria
  titulo01 = "[COLOR orange]CANALES ARENAVISION[/COLOR] (actualizado: "+last_update+")"
  plugintools.add_item( title = titulo01 , thumbnail = generar_miniatura('calendar'), action='', url='', isPlayable = False, folder = False )
...
def listado_eventos(params):
  ...
  # Titulo de la categoria
  titulo01 = "                [COLOR orange][UPPERCASE]"+categoria+"[/UPPERCASE][/COLOR] (actualizado: "+last_update+")"
  plugintools.add_item( title = titulo01 , thumbnail = generar_miniatura('calendar'), action='', url='', isPlayable = False, folder = False )
...
def listado_canales(params):
  ...
  titulo01 = "[COLOR orange] " + categoria + " - " + fecha + "[/COLOR]"
  ...
  titulo01 = "[COLOR white] " + titulo + "[/COLOR]"
