...
if mode==None:
    ...
    line1 = "[COLOR white]Estamos de vuelta![/COLOR]"
    line2 = "[COLOR white]Nueva zona privada; pide la contraseña en nuestro grupo de Telegram.[/COLOR]"
...
if mode==None:
    ...
    line1 = "[COLOR yellow]v3.5 -  Bienvenidos y a disfrutar![/COLOR]"
